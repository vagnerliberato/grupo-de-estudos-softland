...
public class QueryFrame extends JFrame {
    ...
    public static void main(String args[]) throws Exception {
        ...
        try {
            ...
            JOptionPane.showMessageDialog(null, "Não foi possivel encontrar o " +
        ...
        fire.setDriver("org.firebirdsql.jdbc.FBDriver");
        fire.setUrl(prop.getProperty("jdbc.url"));
        fire.setLogin(prop.getProperty("jdbc.user"));
        fire.setSenha(prop.getProperty("jdbc.pass"));

        ResultSetTableModelFactory factory = new ResultSetTableModelFactory(fire.getConexao());
