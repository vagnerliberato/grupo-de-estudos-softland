...
public class TabelaModelo extends AbstractTableModel {
    ...
    private static class Column {
         ...
         * informados 
         *  
         * @param type Classe Java correspondente ao tipo de dado da coluna 
    ...
    /** 
     * Instancia um {@link TabelaModelo} para o {@link ResultSet} 
     * informado 
     *  
     * @param rs O {@link ResultSet} que a {@link JTable} deste modelo irá renderizar 
     * @throws SQLException 
     * @throws ClassNotFoundException 
     */
    public TabelaModelo(final ResultSet rs) throws SQLException, ClassNotFoundException {
